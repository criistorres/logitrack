# Generated by Django 5.2.1 on 2025-06-07 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('INICIADA', 'Iniciada'), ('EM_CARREGAMENTO', 'Em Carregamento'), ('EM_TRANSITO', 'Em Trânsito'), ('ENTREGUE', 'Entregue'), ('ENTREGUE_PARCIAL', 'Entregue Parcialmente'), ('CANCELADA', 'Cancelada')], default='INICIADA', help_text='Status atual da OT', max_length=20, verbose_name='Status')),
                ('cliente_nome', models.CharField(blank=True, help_text='Nome ou razão social do cliente', max_length=200, verbose_name='Nome do Cliente')),
                ('endereco_entrega', models.CharField(help_text='Endereço completo de entrega', max_length=300, verbose_name='Endereço de Entrega')),
                ...
                ('latitude_origem', models.DecimalField(blank=True, decimal_places=15, help_text='Latitude do local de criação da OT (-90 a +90)', max_digits=18, null=True, verbose_name='Latitude de Origem')),
                ('longitude_origem', models.DecimalField(blank=True, decimal_places=15, help_text='Longitude do local de criação da OT (-180 a +180)', max_digits=17, null=True, verbose_name='Longitude de Origem')),
                ...
                ('latitude_entrega', models.DecimalField(blank=True, decimal_places=15, help_text='Latitude do local de entrega (-90 a +90)', max_digits=18, null=True, verbose_name='Latitude de Entrega')),
                ('longitude_entrega', models.DecimalField(blank=True, decimal_places=15, help_text='Longitude do local de entrega (-180 a +180)', max_digits=17, null=True, verbose_name='Longitude de Entrega')),
                ...
                ('data_criacao', models.DateTimeField(auto_now_add=True, help_text='Data e hora de criação da OT', verbose_name='Data de Criação')),
                ...
                ('data_finalizacao', models.DateTimeField(blank=True, help_text='Data e hora de finalização da OT', null=True, verbose_name='Data de Finalização')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longitude', models.DecimalField(blank=True, decimal_places=15, max_digits=17, null=True, verbose_name='Longitude')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('arquivo', models.FileField(help_text='Arquivo do documento', upload_to='ots/%Y/%m/', verbose_name='Arquivo')),
                ('tipo', models.CharField(choices=[('CANHOTO', 'Canhoto de Entrega'), ('FOTO_ENTREGA', 'Foto da Entrega'), ('COMPROVANTE', 'Comprovante'), ('DOCUMENTO', 'Documento'), ('OUTRO', 'Outro')], default='DOCUMENTO', max_length=20, verbose_name='Tipo de Arquivo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PENDENTE', 'Pendente de Aprovação'), ('AGUARDANDO_ACEITACAO', 'Aguardando Aceitação do Motorista'), ('APROVADA', 'Aprovada'), ('REJEITADA', 'Rejeitada'), ('CANCELADA', 'Cancelada')], default='PENDENTE', max_length=25, verbose_name='Status')),
